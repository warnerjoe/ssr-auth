...
import { mockUsersController, registerUserMock, loginUserMock } from '../../utils/test_helpers/mocks/usersControllerMock';

jest.mock('../../controllers/usersController', () => mockUsersController);
